...
class ConvolutionalAE(nn.Module):
    ...
    def __init__(self, encoder_conv_sizes, encoder_mlp_sizes,
        ...
        self.encoder = ConvolutionalEncoderWithLatent(encoder_conv_sizes, encoder_mlp_sizes, latent_size, connector_shape=conv_to_mlp_shape)
...
class ConvolutionalDecoder(nn.Module):
    ...
    def __init__(self, conv_features_sizes, linear_layer_sizes, latent_size, connector_shape):
        ...
        self.mlp.add_module(name=f"d-linear{len(linear_layer_sizes)+1}", module=nn.Linear(linear_layer_sizes[-1], mlp_output_shape))
